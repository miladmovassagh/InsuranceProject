...
import controller.SocialSupplyInsuranceServicesController;
...
public class SocialSupplyInsuranceServices {
    public static JFrame jFrame, jFrame1, jFrame2, jFrame3;

    public SocialSupplyInsuranceServices() {
        jFrame = new JFrame("Social Supply Insurance Services");
        jFrame.setSize(400, 400);
        jFrame.getContentPane().setBackground(Color.WHITE);
        Font font = new Font("TimesRoman", Font.ITALIC, 26);
        ImageIcon icon = new ImageIcon("Icon\\Social Supply.jpg");
    ...
    public void registerNewInsurance() {
        ...
        btnRegister.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    SocialSupplyInsuranceServicesController.getInstance().insert(txtFullName.getText(), txtNationalId.getText(), txtCertificateId.getText(), txtFatherName.getText(), txtPhoneNumber.getText(), txtHomePhone.getText(), birthDate, txtAddress.getText(), nationality,
    ...
    public void payAnnualPremium() {
        ...
        btnPay.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    SocialSupplyInsuranceServicesController.getInstance().update(Long.parseLong(txtPaymentCode.getText()), Long.parseLong(txtTrackingCode.getText()), salary);
                } catch(Exception e1) {
                    JOptionPane.showMessageDialog(null, e1.getMessage(), "ERROR", JOptionPane.WARNING_MESSAGE);
                }
            }
    ...
    public void contractInsuranceCancellation() {
        ...
        btnCancellation.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    SocialSupplyInsuranceServicesController.getInstance().update(Long.parseLong(txtPaymentCode.getText()));
                } catch(Exception e1) {
                    JOptionPane.showMessageDialog(null, e1.getMessage(), "ERROR", JOptionPane.WARNING_MESSAGE);
                }
            }
