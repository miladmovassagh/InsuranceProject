...
import controller.SocialSupplyInsuranceEmployeesController;

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;

public class SocialSupplyInsuranceEmployeesSignUp {
    ...
    public void signUp() {
        ...
        btnSignUp.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    SocialSupplyInsuranceEmployeesController.getInstance().insert(txtFullName.getText(), txtUsername.getText(), txtPassword.getText(), txtNationalId.getText(), txtPhoneNumber.getText(), txtHomePhone.getText(),
