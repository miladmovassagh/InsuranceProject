...
import controller.KosarInsuranceEmployeesController;

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;

public class KosarInsuranceEmployeesSignUp {
    ...
    public void signUp() {
        ...
        btnSignUp.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    KosarInsuranceEmployeesController.getInstance().insert(txtFullName.getText(), txtUsername.getText(), txtPassword.getText(), txtNationalId.getText(), txtPhoneNumber.getText(), txtHomePhone.getText(),
