...
public class IranInsuranceEmployeesSignUp {
    ...
    public void signUp() {
        ...
        btnSignUp.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    IranInsuranceEmployeesController.getInstance().insert(txtFullName.getText(), txtUsername.getText(), txtPassword.getText(), txtNationalId.getText(), txtPhoneNumber.getText(), txtHomePhone.getText(),
