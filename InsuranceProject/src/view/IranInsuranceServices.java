...
import controller.IranInsuranceServicesController;
...
public class IranInsuranceServices {
    public static JFrame jFrame, jFrame1, jFrame2, jFrame3;

    public IranInsuranceServices() {
        jFrame = new JFrame("Iran Insurance Services");
    ...
    public void registerNewInsurance() {
        ...
        btnRegister.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    IranInsuranceServicesController.getInstance().insert(txtFullName.getText(), txtNationalId.getText(), txtCertificateId.getText(), txtFatherName.getText(), txtPhoneNumber.getText(), txtHomePhone.getText(), birthDate, txtAddress.getText(), nationality,
    ...
    public void payAnnualPremium() {
        ...
        btnPay.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    IranInsuranceServicesController.getInstance().update(Long.parseLong(txtPaymentCode.getText()), Long.parseLong(txtTrackingCode.getText()), salary);
                } catch(Exception e1) {
                    JOptionPane.showMessageDialog(null, e1.getMessage(), "ERROR", JOptionPane.WARNING_MESSAGE);
                }
            }
    ...
    public void contractInsuranceCancellation() {
        ...
        btnCancellation.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    IranInsuranceServicesController.getInstance().update(Long.parseLong(txtPaymentCode.getText()));
                } catch(Exception e1) {
                    JOptionPane.showMessageDialog(null, e1.getMessage(), "ERROR", JOptionPane.WARNING_MESSAGE);
                }
            }
